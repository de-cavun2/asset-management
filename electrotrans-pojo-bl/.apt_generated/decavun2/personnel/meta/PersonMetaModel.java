 ...
 * <p>
 * Generation datetime: 18-01-2023 19:48:50.844 EET
 * <p>
...
@Generated(
        ...
        date = "2023-01-18T19:48:50.844+02:00"
)
...
public class PersonMetaModel extends EntityMetaModel {
    ...
    public static final String personRole_ = "personRole";
    ...
    private Supplier<PersonRoleMetaModel> personRole;
    ...
    public PersonMetaModel(final String path) {
        ...
        this.personRole = () -> {
                  decavun2.personnel.meta.PersonRoleMetaModel value = new decavun2.personnel.meta.PersonRoleMetaModel(joinPath(personRole_));
                  personRole = () -> value;
                  return value;
                };
     ...
     * Title: Full name
     * <p>
     * Description: Person's full name - e.g. the first name followed by the middle initial followed by the surname.
     * <p>
     * Type: {@link String}
     * <p>
     * {@literal @}{@link IsProperty}<br>
     * {@literal @}{@link Readonly}<br>
     * {@literal @}{@link Calculated}<br>
     * {@literal @}{@link Title}(value = "Full name", desc = "Person's full name - e.g. the first name followed by the middle initial followed by the surname.")
     */
     ...
     * {@literal @}{@link Title}(value = "First Name", desc = "Person's first name.")<br>
     * {@literal @}{@link BeforeChange}(value = {{@literal @}ua.com.fielden.platform.entity.annotation.mutator.Handler(value = decavun2.personnel.validators.NoSpacesValidator.class)})
     */
     ...
     * <p>
     * Type: {@link decavun2.personnel.PersonRole}
     * <p>
     * Meta-model: {@link PersonRoleMetaModel}
     * <p>
     * {@literal @}{@link IsProperty}<br>
     * {@literal @}{@link MapTo}<br>
     * {@literal @}{@link Title}(value = "Role", desc = "Person's role, position or title.")
     */
    public PersonRoleMetaModel personRole() {
     ...
     * {@literal @}{@link MapTo}<br>
     * {@literal @}{@link Required}<br>
     * {@literal @}{@link Title}(value = "Last Name", desc = "Person's last name.")<br>
     * {@literal @}{@link BeforeChange}(value = {{@literal @}ua.com.fielden.platform.entity.annotation.mutator.Handler(value = decavun2.personnel.validators.NoSpacesValidator.class)})
     */
