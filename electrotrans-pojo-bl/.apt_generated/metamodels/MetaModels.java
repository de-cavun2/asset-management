...
import decavun2.change.meta.ChangeMetaModel;
import decavun2.change.meta.ChangeMetaModelAliased;
import decavun2.change.meta.IssueMetaModel;
import decavun2.change.meta.IssueMetaModelAliased;
...
/**
 * Generation datetime: 19-01-2023 21:28:42.744 EET
 * <p>
...
@Generated(
        ...
        date = "2023-01-19T21:28:42.744+02:00"
)
public final class MetaModels {
    public static final ChangeMetaModel Change_ = new ChangeMetaModel();

    public static final IssueMetaModel Issue_ = new IssueMetaModel();
    ...
    public static ChangeMetaModelAliased Change_(final String alias) {
        final ChangeMetaModelAliased aliased = new ChangeMetaModelAliased(alias);
        return aliased;
    }

    public static IssueMetaModelAliased Issue_(final String alias) {
        final IssueMetaModelAliased aliased = new IssueMetaModelAliased(alias);
        return aliased;
    }
